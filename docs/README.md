...
### This README is a quick guide to get the project up and running locally. For more information contact Bourouis Mohamed or Chitoui Mohamed
```text
electron
-------->|---------------|   executes 
         |   electron    |-------------> |-------------------|
...
2. If you don't have it already, install [Python39](https://www.python.org/downloads/). Python3 is used for emotion classification.
