...
function start_code_function(evt) {
    ...
    // Use the correct Python executable from your virtual environment
    const pythonPath = "C:/ProgramData/anaconda3/envs/emotion_env/python.exe"; // Replace with your Python path

    child = exec(`${pythonPath} ./external_programs/classify.py`, function (error, stdout, stderr) {
        if (error !== null) {
